...
def return_rules():
    text='Ваша задача - без слов и указаний на существующие предметы объяснить вашим друзьям значение предложенного слова. ' \
         'Кто из них отгадает - тот и объясняет объясняет следующее слово.\n\n' \
