...
def return_rules():
    ...
    speech='Ведущий описывает странную ситуацию, а угадывающие должны выяснить её, ' \
         'задавая ведущему вопросы, на которые можно ответить только «да», «нет», «не имеет значения» или «не корректно»\n\n' \
         ' - - - Вы можете использовать команду "пропустить" с любым числом, чтобы перейти к более сложным ситуациям.'
...
def return_more_details():
    text = 'Телефон находится в руках у ведущего. На экране ведущий видит ситуацию и ответ к ней. Например: \n\n' \
           ...
           'Ответ: он купил билет, что узнать время.\n\n' \
           'В то же время, друзья ведущего слышат только саму ситуацию и должны задавать ведущему вопросы, чтобы узнать ответ. ' \
           'Задавать можно только вопросы, ответы на которые "да" или "нет". Помимо этого ведущий может ответь "не имеет значения" или "не корректно".'
