...
def return_rules(user_id, database):
    ...
    text='Ведущий описывает странную ситуацию. Угадывающие должны разгадать ситуацию. ' \
         'Они могут задавать ведущему вопросы, на которые можно ответить только «да», «нет»,' \
         ' «не имеет значения» или «не корректно»\n\n' \
         'Во время игры вы сможете использовать команду "пропустить" с любым числом, ' \
         'чтобы перейти к более сложным ситуациям.'
    speech='Ведущий описывает странную ситуацию. Угадывающие должны разгадать ситуацию. ' \
           'Они могут задавать ведущему вопросы, на которые можно ответить только «да», «нет», ' \
           '«не имеет значения» или «не корректно»\n\n' \
           ' - - - Во время игр+ы вы сможете использовать команду "пропустить" с любым числом, ' \
           'чтобы перейти к более сложным ситуациям.'
...
def return_more_details(user_id, database):
    ...
    text = 'Телефон находится в руках у ведущего. На экране ведущий видит ситуацию и ответ к ней. Например: \n\n' \
           'Человек на вокзале покупает в кассе билет, ему говорят „Поезд через 13 минут“. ' \
           'Человек смотрит на билет и выбрасывает. Почему?\n\n' \
           ...
           'Задавать можно только вопросы, ответы на которые "да" или "нет". Помимо этого ведущий может ответить' \
           ' "не имеет значения" или "не корректно".'
    speech = 'Телефон находится в руках у ведущего. На экране ведущий видит ситуацию и ответ к ней.' \
             ' Например: \n\n - - -' \
             'Человек на вокзале покупает в кассе билет, ему говорят „Поезд через 13 минут“. ' \
             'Человек смотрит на билет и выбрасывает. - Почему?\n\n' \
             'Ответ: он купил билет, чтобы узнать время.\n\n - - - ' \
